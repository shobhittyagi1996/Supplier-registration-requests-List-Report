		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Supplier Registration Requests List Report",
									"targetURL": "#comsapsupplierregistrationrequest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapsupplierregistrationrequest-display": {
								"semanticObject": "comsapsupplierregistrationrequest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.supplierregistrationrequest",
									"url": sap.ui.require.toUrl("com/sap/supplierregistrationrequest")
								}
							}
						}
					}
